...
public class ChatPanel extends ContentPanel {
	...
	protected final ContentPanel southPanel = new ContentPanel(new FitLayout());

	protected final TextArea text = new TextArea();

	protected int textAreaSize = 100;
	...
	// setText("* " +
	// Translations.instance.chatWithTabName(chat.getJid().getBareJid().toString()));
	...
	private void sendMessage() {
		...
		try {
			...
			ChatPanel.this.chat.sendMessage(v);
		} catch (Exception e) {
