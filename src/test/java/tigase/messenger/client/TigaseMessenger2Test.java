...
import tigase.messenger.shared.FieldVerifier;
 ...
 */
public class TigaseMessenger2Test extends GWTTestCase {
	...
	public String getModuleName() {
		return "tigase.messenger.TigaseMessenger2JUnit";
	}
	...
	public void testGreetingService() {
		...
		target.setServiceEntryPoint(GWT.getModuleBaseURL() + "tigasemessenger2/greet");
